...
This data constitutes the [FiveThirtyEight Comic Characters Dataset](https://www.kaggle.com/datasets/fivethirtyeight/fivethirtyeight-comic-characters-dataset) and is made available under a [CC0 Public Domain license](./LICENSE.txt).
